...
use App\Filament\Gerente\Resources\ThirdPartyPropertyResource\Pages;
use App\Filament\Gerente\Resources\ThirdPartyPropertyResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Section::make('Adjuntos')
                    ->columns(12)
                    ->schema([
                        FileUpload::make('contract_path')->label('Contrato (PDF/JPEG/PNG)')->acceptedFileTypes(['application/pdf', 'image/jpeg', 'image/png'])->directory('tdp/contracts/' . now()->format('Y/m/d'))->preserveFilenames() ->disk('azure_public')
                            ->visibility('public') ->downloadable()->required()->columnSpan(6),
