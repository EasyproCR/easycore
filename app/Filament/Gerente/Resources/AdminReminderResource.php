...
use App\Filament\Gerente\Resources\AdminReminderResource\Pages;
...
class AdminReminderResource extends Resource
{
    ...
    {
        return [
            \App\Filament\Gerente\Resources\AdminReminderResource\RelationManagers\ActivityResultsRelationManager::class,
        ];
    }
