...
use App\Filament\Personal\Resources\ThirdPartyPropertyResource\Pages;
                ...
                Section::make('Información de la propiedad')
                    ...
                    ->schema([
                        ...
                        Select::make('status')->label('Estado de la propiedad')->options([
                            ...
                            'rejected' => 'Rechazada',
                        ])->default('pending')->required()->columnSpan(3)->disabled(),
                    ...
                    ->schema([
                        Select::make('personal_customer_id')->label('Propietario')->options(
                            ...
                            PersonalCustomer::query()
                                ...
                                ->limit(500)
                                ->pluck('full_name', 'id')
                        )->searchable()->preload()->columnSpan(6),
                        ...
                        )->disabled()->searchable()->preload()->columnSpan(6),
                    ]),
